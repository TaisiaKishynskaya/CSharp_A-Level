...
public class CatalogService : ICatalogService
{
    ...
    public async Task<ViewModels.Catalog> GetCatalogItems(int page, int take, int? brand, int? type)
    {
        ...
        var result = await _httpClient.SendAsync<ViewModels.Catalog, PaginatedItemsRequest<CatalogTypeFilter>>($"{_settings.Value.CatalogUrl}/items",
           HttpMethod.Post, 
