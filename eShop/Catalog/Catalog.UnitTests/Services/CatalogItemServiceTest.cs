...
public class CatalogItemServiceTest
{
    ...
    private readonly AddCatalogItemRequest _testItem = new()
    {
        Name = "TestName",
    ...
    public async Task GetByPageAsyncHttpGet_Success()
    {
        ...
        {
            new() { Id = 1, Name = "Item1", Description = "Description1", Price = 100, PictureFileName = "1.png", CatalogBrand = new CatalogBrand { Brand = "Brand1" }, CatalogType = new CatalogType { Type = "Type1" } },
            new() { Id = 2, Name = "Item2", Description = "Description2", Price = 200, PictureFileName = "2.png", CatalogBrand = new CatalogBrand { Brand = "Brand2" }, CatalogType = new CatalogType { Type = "Type2" } }
        };
